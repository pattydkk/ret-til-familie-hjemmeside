...
function displayUsers(users) {
    ...
    users.forEach(user => {
        ...
        const stripeId = user.stripe_customer_id ? `<small style="color: #10b981;">✓ ${user.stripe_customer_id.substring(0, 12)}...</small>` : '<small style="color: #ef4444;">✗ Ingen</small>';
